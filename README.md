...
~~~sh
# getting the code
git clone git@github.com:nko5/utah-node-js.git && cd ./utah-node-js/
...
~~~html
<iframe src="http://nodeknockout.com/iframe/utah-node-js" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
